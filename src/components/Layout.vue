    ...
    >
      <v-list dense>
        ...
        <v-list-item link>
          ...
          <v-list-item-content>
            <v-list-item-title>Random Character</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item link>
          <v-list-item-action>
          ...
          <v-list-item-content>
            <v-list-item-title>Random Quote</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item link>
          <v-list-item-action>
        ...
        <v-list-item link>
          ...
          <v-list-item-content>
            <v-list-item-title>Random Death Information</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    </v-navigation-drawer>
